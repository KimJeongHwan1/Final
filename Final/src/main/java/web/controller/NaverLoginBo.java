...
public class NaverLoginBo {
	...
	private final static String CLIENT_ID = "QTZGRRn_QQmhGLjrVzDq";
	private final static String CLIENT_SECRET = "VQgHoC5zIM";
	private final static String REDIRECT_URI = "http://localhost:8088/member/main";
