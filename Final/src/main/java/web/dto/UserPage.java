...
public class UserPage {
	...
	private String multimainstoredname;
	...
	public String toString() {
		return "UserPage [content_no=" + content_no + ", content_title=" + content_title + ", content=" + content
				...
				+ storedname + ", multimainstoredname=" + multimainstoredname + ", blockSee=" + blockSee
				+ ", comm_count=" + comm_count + ", addno=" + addno + ", address=" + address + ", x=" + x + ", y=" + y
				+ "]";
	}
	...
	public String getMultimainstoredname() {
		return multimainstoredname;
	}
	public void setMultimainstoredname(String multimainstoredname) {
		this.multimainstoredname = multimainstoredname;
	}
