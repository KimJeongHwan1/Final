...
<form action="/member/join" name="joinForm" method="POST"
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="idcheck" name="member_id" placeholder="ID"
	...
	<div class="form-group">
		<label for="member_pw2">비밀번호 확인</label> <input type="password"
			class="form-control" name="member_pwCheck"
	...
	<div class="form-group required">
		<label for="member_birth">생년월일</label> <input type="text"
			class="form-control" id="member_birth" name="member_birth"
			placeholder="ex) 1999/04/15" required>
		<div class="check_font" id="birth_check"></div>
	</div>
	<!-- 본인확인 이메일 -->
	<div class="form-group">
		<label for="member_email">이메일</label> <input type="email"
			class="form-control" name="member_email" id="member_email"
	...
	<!-- 휴대전화 -->
	<div class="form-group">
		<label for="member_phone">휴대전화 ('-' 없이 번호만 입력해주세요)</label> <input
			type="text" class="form-control" id="member_phone"
			name="member_phone" placeholder="Phone Number" required>
	...
	<div class="form-group">
		...
		<input type="text"	class="form-control" id="member_addressnum" name="member_addressnum"
			placeholder="우편번호" required>
		 <input type="text"	class="form-control" id="member_address" name="member_address"
			placeholder="상세주소" required>
		 <input type="button" class="btn btn-primary" style="background-color: #32B16C !important; padding: 1% 10;"
			onclick="sample6_execDaumPostcode()" class="form-control" value="주소 찾기">
	</div>
